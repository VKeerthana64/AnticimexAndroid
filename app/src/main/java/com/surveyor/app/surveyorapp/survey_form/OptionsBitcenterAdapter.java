...
public class OptionsBitcenterAdapter extends RecyclerView.Adapter<OptionsBitcenterAdapter.ViewHolder> {

    ArrayList<OptionBean.BinCenter> list;
    Context context;
    OnItemClickListener onItemClickListener;
    OnValueSelectedListener onValueSelectedListener;
    public OptionsBitcenterAdapter(ArrayList<OptionBean.BinCenter> list, Context context) {
        this.list = list;
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        ...
        final OptionBean.BinCenter bean = list.get(position);
        ...
        holder.cbSelection.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                OptionBean.BinCenter bean = (OptionBean.BinCenter) cb.getTag();
    ...
    public interface OnItemClickListener {
        void onItemClickListener(int position, OptionBean.BinCenter bean);
    }

    public ArrayList<OptionBean.BinCenter> adapterList() {
        return list;
    }

    public OptionBean.BinCenter getItem(int position) {
