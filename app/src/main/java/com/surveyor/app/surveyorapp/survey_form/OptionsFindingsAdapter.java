...
public class OptionsFindingsAdapter extends RecyclerView.Adapter<OptionsFindingsAdapter.ViewHolder> {

    ArrayList<OptionBean.Findings> list;
    Context context;
    OnItemClickListener onItemClickListener;
    OnValueSelectedListener onValueSelectedListener;
    public OptionsFindingsAdapter(ArrayList<OptionBean.Findings> list, Context context) {
        this.list = list;
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        ...
        final OptionBean.Findings bean = list.get(position);
        ...
        holder.cbSelection.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                OptionBean.Findings bean = (OptionBean.Findings) cb.getTag();
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (onItemClickListener != null) {
                    onItemClickListener.onFindingsItemClickListener(position, list.get(position));
                }
            }
        });
    }
    ...
    public interface OnItemClickListener {
        void onFindingsItemClickListener(int position, OptionBean.Findings bean);
    }
    ...
    public ArrayList<OptionBean.Findings> adapterList() {
        return list;
    }

    public OptionBean.Findings getItem(int position) {
