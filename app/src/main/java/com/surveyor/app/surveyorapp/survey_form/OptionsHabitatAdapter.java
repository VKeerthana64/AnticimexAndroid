...
public class OptionsHabitatAdapter extends RecyclerView.Adapter<OptionsHabitatAdapter.ViewHolder> {

    ArrayList<OptionBean.Habitate> list;
    Context context;
    OnItemClickListener onItemClickListener;
    OnValueSelectedListener onValueSelectedListener;

    public OptionsHabitatAdapter(ArrayList<OptionBean.Habitate> list, Context context) {
        this.list = list;
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        ...
        final OptionBean.Habitate bean = list.get(position);
        ...
        holder.cbSelection.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                OptionBean.Habitate bean = (OptionBean.Habitate) cb.getTag();
    ...
    public interface OnItemClickListener {
        void onItemClickListener(int position, OptionBean.Habitate bean);
    }

    public ArrayList<OptionBean.Habitate> adapterList() {
        return list;
    }

    public OptionBean.Habitate getItem(int position) {
