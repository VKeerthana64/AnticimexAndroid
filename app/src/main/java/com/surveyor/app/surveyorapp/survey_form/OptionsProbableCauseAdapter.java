...
public class OptionsProbableCauseAdapter extends RecyclerView.Adapter<OptionsProbableCauseAdapter.ViewHolder> {

    ArrayList<OptionBean.ProbableCauseOfBurrows> list;
    Context context;
    OnItemClickListener onItemClickListener;
    OnValueSelectedListener onValueSelectedListener;
    public OptionsProbableCauseAdapter(ArrayList<OptionBean.ProbableCauseOfBurrows> list, Context context) {
        this.list = list;
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        ...
        final OptionBean.ProbableCauseOfBurrows bean = list.get(position);
        ...
        holder.cbSelection.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                OptionBean.ProbableCauseOfBurrows bean = (OptionBean.ProbableCauseOfBurrows) cb.getTag();
    ...
    public interface OnItemClickListener {
        void onItemClickListener(int position, OptionBean.ProbableCauseOfBurrows bean);
    }

    public ArrayList<OptionBean.ProbableCauseOfBurrows> adapterList() {
        return list;
    }

    public OptionBean.ProbableCauseOfBurrows getItem(int position) {
