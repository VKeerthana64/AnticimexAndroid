...
public class OptionsRemarksAdapter extends RecyclerView.Adapter<OptionsRemarksAdapter.ViewHolder> {

    ArrayList<OptionBean.Remarks> list;
    Context context;
    OnItemClickListener onItemClickListener;
    OnValueSelectedListener onValueSelectedListener;
    public OptionsRemarksAdapter(ArrayList<OptionBean.Remarks> list, Context context) {
        this.list = list;
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        ...
        final OptionBean.Remarks bean = list.get(position);
        ...
        holder.cbSelection.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                OptionBean.Remarks bean = (OptionBean.Remarks) cb.getTag();
    ...
    public interface OnItemClickListener {
        void onItemClickListener(int position, OptionBean.Remarks bean);
    }

    public ArrayList<OptionBean.Remarks> adapterList() {
        return list;
    }

    public OptionBean.Remarks getItem(int position) {
