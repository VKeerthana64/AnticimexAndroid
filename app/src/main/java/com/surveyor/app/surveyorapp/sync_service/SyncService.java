...
public class SyncService {
    ...
    static ArrayList<OptionBean.Findings> arrOptionFindings = new ArrayList<>();
    static ArrayList<OptionBean.Habitate> arrOptionHabitat = new ArrayList<>();
    static ArrayList<OptionBean.Remarks> arrOptionRemarks = new ArrayList<>();
    static ArrayList<OptionBean.BinCenter> arrOptionBitcenter = new ArrayList<>();
    static ArrayList<OptionBean.ActionTaken> arrOptionActionTaken = new ArrayList<>();
    static ArrayList<OptionBean.ProbableCauseOfBurrows> arrOptionProbable = new ArrayList<>();

    public static void getSyncAllData(final Context context) {
        ...
        getAllOptions(context,dbHandler,sharedObjects);
        getJobType(context,dbHandler,sharedObjects);
        getAllTechnician(context,dbHandler,sharedObjects);
        ...
        if (!TextUtils.isEmpty(sharedObjects.getPreference(AppConstants.LOGIN_BEAN))) {
            if (sharedObjects.getUserInfo().getUserrole().equalsIgnoreCase(AppConstants.ROLE.TECHNICIAN)) {
                ...
                if (dbHandler.getCount() == 0) {
                    getJobListForSync(context,dbHandler,sharedObjects);
                } else {
                        ...
                        for (int i = 0; i < arrMain.size(); i++) {
                            ...
                            for (int j = 0; j < arrForms.size(); j++) {
                                if (arrForms.get(j).getIsSync() == 1) {
                                    submitSurveyForm(beanMain, arrForms, j,context,dbHandler,sharedObjects);
                                } else if (arrForms.get(j).getIsSync() == 2) {  //submit delete form
                                    deleteSurveyForm(beanMain, arrForms, j,context,dbHandler,sharedObjects);
                                }
                            }
                        }
                    } else {
...
//                    JobAllSyncDataBean beanMain = dbHandler.getSingleUnsyncJob(sharedObjects.getUserId());
                            ...
                            for (int j = 0; j < arrTeamMember.size(); j++) {
                                if (arrTeamMember.get(j).getIsSync() == 1) {
                                    if (arrTeamMember.get(j).isAssigned()) {
                                        addTeamMembers(beanMain, arrTeamMember, j,context,dbHandler,sharedObjects);
                                    } else {
                                        removeTeamMembers(beanMain, arrTeamMember, j,context,dbHandler,sharedObjects);
                                    }
                                }
                            }
                        }
    ...
    public static void deleteSurveyForm(final JobAllSyncDataBean beanMain, final ArrayList<JobAllSyncAllSurveyBean> arrForms,
                                        final int position,final Context context, final DBHandler dbHandler,final SharedObjects sharedObjects) {
...
//                            adapter.notifyDataSetChanged();
    ...
    public static void submitSurveyForm(final JobAllSyncDataBean beanMain, final ArrayList<JobAllSyncAllSurveyBean> arrForms,
                                        final int position,final Context context, final DBHandler dbHandler,final SharedObjects sharedObjects) {
        ...
        call.enqueue(new Callback<JsonElement>() {
            ...
            public void onResponse(Call<JsonElement> call, Response<JsonElement> response) {
                try {
                    if (response.isSuccessful()) {
                     ...
                     //   Toast.makeText(SyncService.this, jsonObject.getString(AppConstants.RESPONSE.msg), Toast.LENGTH_SHORT).show();
                    } else if (response.code() == 401) {
                        try {
            ...
            @Override
            public void onFailure(Call<JsonElement> call, Throwable t) {
               // Toast.makeText(SyncService.this, getString(R.string.something_went_wrong), Toast.LENGTH_SHORT).show();
            }
        });
    }

    public static boolean checkAllJobDataSync(JobAllSyncDataBean bean) {
        int count = 0;
    ...
    public static boolean checkAllJobTeamMemberSync(JobAllSyncDataBean bean) {
        int count = 0;
    ...
    public static void getJobListForSync(Context context, final DBHandler dbHandler,final SharedObjects sharedObjects) {
    ...
    public static void addTeamMembers(final JobAllSyncDataBean beanMain, final ArrayList<TeamMemberDataBean> arrTeamMember, final int position,final Context context, final DBHandler dbHandler,final SharedObjects sharedObjects) {
    ...
    public static void removeTeamMembers(final JobAllSyncDataBean beanMain, final ArrayList<TeamMemberDataBean> arrTeamMember, final int position
            ,final Context context, final DBHandler dbHandler,final SharedObjects sharedObjects) {
    ...
    public static void getJobType(Context context, DBHandler dbHandler,final SharedObjects sharedObjects) {
    ...
    public static void getAllTechnician(Context context, DBHandler dbHandler,final SharedObjects sharedObjects) {
    ...
    public static void getAllOptions(Context context, final DBHandler dbHandler,final SharedObjects sharedObjects) {
